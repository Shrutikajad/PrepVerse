...
const Fotter = () => {
  return (
    <div className=" border-800 mt-6 pt-6 text-m text-center ">
      <h1>© 2025 PrepVerse. All rights reserved.</h1> 
    </div>
  )
}
